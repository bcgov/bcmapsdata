...
#'
#' @format An `sf` layer defining the boundary of each British Columbia. Scale is 1:7.5M
#'
...
#' under the \href{http://open.canada.ca/en/open-government-licence-canada}{Open Government Licence - Canada} version 2.0.
#'
"bc_bound"
